...
`;
        ...
        it('should parse math when enableMath is true', () => {
            ...
            const actual = (0, src_1.markdownToBlocks)(text, { enableMath: true });
            const expected = [
                notion.paragraph([
        ...
        it('should NOT parse dollar signs as equations when enableMath is false (Issue #48)', () => {
            ...
            const actual = (0, src_1.markdownToBlocks)(text); // enableMath defaults to false
            const expected = [
                notion.paragraph([
...
| A | B |`;
        ...
        it('should split paragraphs on hard line breaks', () => {
            ...
            const expected = [
                ...
                notion.paragraph([
                    notion.richText('This is the second line of text.\nAnd this is in the same line'),
                ]),
            ];
            expect(actual).toStrictEqual(expected);
        });
