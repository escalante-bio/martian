...
export declare const SUPPORTED_GFM_ALERT_TYPES: readonly ["NOTE", "TIP", "IMPORTANT", "WARNING", "CAUTION"];
export type GfmAlertType = (typeof SUPPORTED_GFM_ALERT_TYPES)[number];
export declare function isGfmAlertType(type: string): type is GfmAlertType;
export declare const GFM_ALERT_MAP: Record<GfmAlertType, {
    emoji: EmojiRequest;
    color: ApiColor;
}>;
export declare const SUPPORTED_EMOJI_COLOR_MAP: Partial<Record<EmojiRequest, ApiColor>>;
