...
export type FlowContent = Blockquote | Code | Heading | HTML | List | Image | ImageReference | ThematicBreak | Content | Table | Math;
export type Content = Definition | Paragraph;
export type ListContent = ListItem;
export type PhrasingContent = Link | LinkReference | StaticPhrasingContent;
export type StaticPhrasingContent = Image | Break | Emphasis | HTML | ImageReference | InlineCode | Strong | Text | Delete | InlineMath;
